<section class="content">
	...
	// die;
			...
			<div class="form-group">
				<div class="row">
					<div class="col-sm-12 paymentoption">
						<a href="#"><img src="/kindplanner_dta/img/paypal.png" alt="user" class="table-img-thumb img-circle"></a>
					...
					<div class="col-sm-12 paymentoption">
						<a href="#"><img src="/kindplanner_dta/img/ideal.png" alt="user" class="table-img-thumb img-circle"></a>
					...
					<div class="col-sm-12 paymentoption">
						<a href="#"><img src="/kindplanner_dta/img/visa.png" alt="user" class="table-img-thumb img-circle"></a>
					...
					<div class="col-sm-12 paymentoption">
						<a href="#"><img src="/kindplanner_dta/img/mastercard.png" alt="user" class="table-img-thumb img-circle"></a>
		...
		<div class="block-header payment">
			...
			<?php 
				// echo $this->Form->create('service',['class'=>'','type'=>'file','controller' => 'users', 'action' => 'offlinePayment', 'prefix' => 'parent']); 
				// echo $this->Form->control('bso_id', ['label' => false, 'class' => 'form-control','type'=>'hidden','value'=> $bso_id]);
				// echo $this->Form->control('parent_id', ['label' => false, 'class' => 'form-control','type'=>'hidden','value'=> $parent_id]);
				// echo $this->Form->control('child_id', ['label' => false, 'class' => 'form-control','type'=>'hidden','value'=> $child_id]);
				// echo $this->Form->control('planid[]', ['label' => false, 'class' => 'form-control','type'=>'hidden','value'=> json_encode($planides)]);
