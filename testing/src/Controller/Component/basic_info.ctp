										...
										<div class="tab-content">
											<div id="Persoonsgegevens" class="tab-pane fade in active">
												...
												<div class="form-group">
													...
													<?= $this->Form->control('ingestion_date',['label' => false, 'class' => 'datepicker form-control', 'placeholder' => 'Datum intake','requied'=> true,'value'=>$recption[0]['ingestion_date']]);?>
												</div>
												<div class="form-group">
													...
													<div class="row">
														<div class="col-sm-6">
															<div class="form-group">
																<label>Name</label>
																<?= $this->Form->control('name[]',   ['name'=>'data['.$key.'][name]', 'label' => false, 'class' => 'form-control', 'placeholder' => ' Name','value'=>$name]); ?>
													...
													<div class="form-group">
														...
														<?= $this->Form->control('mobile_no', ['label' => false, 'class' => 'form-control', 'placeholder' => 'xxxxxxxxxx','value'=> $recption[0]['mobile_no']]);?>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="row">
														<div class="col-sm-6">
															<div class="form-group">
																<label>Opvang</label>
																<?= $this->Form->control('reception[]',   ['label' => false, 'class' => 'form-control reception','value'=>$value1['reception'] ]);?>																</div>
														</div>
														<div class="col-sm-6">
															<label>Date *</label>
															<?= $this->Form->control('reception_date[]',['label' => false, 'class' => ' form-control receptiondate' , 'placeholder' => 'Datum intake', 'value' => $value1['reception_date']]);?>
														</div>
													</div>
												<?php 
												}
											...
											<div id="gedragsociaal" class="tab-pane fade">
												...
												<div class="row">
													...
													<input name="childbusy" id="radio_53" class="with-gap radio-col-blue-grey" type="radio" value="2" <?php echo ($behaviorandSocial['childbusy']=='2' ? 'checked' : '');?>> 
											...
											<?php echo $this->Form->create($medicalemotionals, ['name'=>'medical', 'class'=>'basicinfo', 'type'=>'file']); ?>
												...
												<div class="row">
													...
													<div class="col-sm-4">
													<input name="group15" id="radio_70" class="with-gap radio-col-blue-grey" type="radio" value="1" <?php if($medicalemotionals['specialdiseases']!== null){echo "checked";}?>> 
												...
												<div class="row">
													...
													<div class="col-sm-4">
													<input name="group16" id="radio_72" class="with-gap radio-col-blue-grey" type="radio" value="1" <?php if($medicalemotionals['allergies']!== null){echo "checked";}?> > 
												...
												<div class="row">
													...
													<div class="col-sm-4">
													<input name="group17" id="radio_74" class="with-gap radio-col-blue-grey" type="radio" value="1" <?php if($medicalemotionals['senses']!== null){echo "checked";}?>> 
