...
?> 
                        ...
                        <li class="pull-right dropdown p-b-10">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <?php
                                        if(!empty($dataimage)){
                                            echo $this->Html->link($this->Html->image(USER_PICTURE_FOLDER_URL_PATH.$uuid.'/'.$dataimage, ['alt' => 'user','class' => 'user-img img-circle']),['controller' => 'users', 'action' => 'profileEdit', 'prefix' => 'parent', $uuid],['escapeTitle' => false,]);
                                        }else{
                                            echo $this->Html->link($this->Html->image('blank-avatar.png', ['alt' => 'user','class' => 'user-img img-circle']),['controller' => 'users', 'action' => 'profileEdit', 'prefix' => 'parent', $uuid],['escapeTitle' => false,]);
                                        }
                                    ?>
                                    <h4><?=$this->request->getSession()->read('Auth.User.name');?></h4>
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <?php echo $this->Html->link('My Profile',['controller' => 'users', 'action' => 'profileEdit', 'prefix' => 'parent', $uuid],['escapeTitle' => false,'class'=>'btn bg-blue-grey btn-lg']);
                                        ?>
                                    </div>
            ...
            <ul class="list">
                ...
                <li class="<?php if($lastWord == 'users'){echo "active" ;} ?>">
                    <?php echo $this->Html->link('<i class="fa fa-home nav-ico"> </i><span>Dashboard</span></i>',
                        ['controller' => 'users', 'action' => 'index','prefix'=>'parent'],['escape' => false,'class'=>'']); ?>
                </li>
                <li class="<?php if($lastWord == 'manage-children'){echo "active" ;} ?>">
                  
                        <?php echo $this->Html->link('<i class="fa fa-cog nav-ico"> </i>
                    <span>Manage Children</span>',
                            ['controller' => 'users', 'action' => 'manageChildren','prefix'=>'parent'],['escape' => false,'class'=>'']); ?>
                    
                    
                </li>
                <li class="<?php if($lastWord == 'manage-guardian'){echo "active" ;} ?>">
                    <?php echo $this->Html->link('<i class="fa fa-cog nav-ico"> </i>
                    <span>Manage Guardian</span>',
                            ['controller' => 'users', 'action' => 'manageGuardian','prefix'=>'parent'],['escape' => false,'class'=>'']); ?>
                    
                </li>
                <li class="header"><i class="fa fa-cogs nav-ico"> </i> Services</li>
                    <li class="<?php if($lastWord == 'buy-services'){echo "active" ;} ?>">
                         <?php echo $this->Html->link('Buy Services',
                            ['controller' => 'users', 'action' => 'buyServices','prefix'=>'parent'],['escape' => false,'class'=>'']); ?>
                        
                    </li>
                    <li class="<?php if($lastWord == 'my-services'){echo "active" ;} ?>">
                        <?php echo $this->Html->link('My Services',
                            ['controller' => 'users', 'action' => 'myServices',$uuid,'prefix'=>'parent'],['escape' => false,'class'=>'']); ?>
                    </li>
                    <li class="<?php if($lastWord == 'myprevious-services'){echo "active" ;} ?>">
                        <?php echo $this->Html->link('My Previous Services',
    ...
    <!-- #END# Left Sidebar -->
        ...
        <footer>
            <!-- Jqueryjquery-confirm.min.css Core Js -->
            <!-- Plugins js -->
