<section class="content">
	<div class="container-fluid">
		<div class="block-header">
			<h2 class="text-uppercase"><i class="fa fa-user"> </i>Reset Your Password</h2>
			<?= $this->Flash->render() ?>
		</div>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 p-t-30">
						...
						<div class="form-group">
							<label for="password">New Password  * <i style="font-size:12px">(Password must contain atleast one capital letter and alphanumeric characters.)</i></label>
							<div id="message">
						...
						<div class="text-right m-b-10 m-t-30">
							<?= $this->Form->button('Reset Password',['class' => 'btn btn-lg bg-teal']);
							echo $this->Form->end();
							?>
						</div>
					</div>
