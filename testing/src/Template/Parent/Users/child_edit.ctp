								...
								<div class="row">
									...
									<div class="col-sm-8 col-md-8">
										...
										<div class="form-group">
											...
											<?= $this->Form->control('dob',['type'=>'text','label' => false, 'class' => 'datepicker form-control', 'placeholder' => 'DOB','value'=>date($this->Decryption->mc_decrypt($user['dob'],$user['encryptionkey']))]);?>
										</div>
