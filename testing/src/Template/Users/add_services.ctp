						...
						<div class="form-common">
								...
								<div class="form-group">
									<div id="example">
											...
											<div class="col-sm-6">
												...
												<?= $this->Form->control('end_time',['type'=>'text','label' => false, 'id'=> 'date-end','class' => 'timepicker endtime form-control', 'placeholder ' => 'End Time']); ?>
												</div>
											</div>
										</div>
										<div class="row demo-section k-content">
										...
										<div class="row demo-section k-content childgroups">
											    ...
											    <div class="row">
											       ...
											       <div class="col-sm-12">
											       	<a href="javascript:void(0)" class="btn bg-teal" data-attr="" id="check_child_groups">Add</a>
											...
											<?= $this->Form->control('keycount',['type'=>'hidden','label' => false, 'class' => 'form-control','value' =>0]); ?>
										</div>
										<div class="row">
											<div class="col-sm-4">
												<div class="form-group">
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<?php// $ServiceTax = array(''=>'-- Please select tax --','Including'=>'Including','Excluding'=>'Excluding'); ?>									
											<?php // $this->Form->input('service_tax1', array('type'=>'select','label'=>false, 'class'=>'form-control show-tick servicetax', 'options'=>$ServiceTax)); ?>
									...
									<div class="col-sm-6">
										<div class="form-group">
											<label>Tax % *</label>
											<?php// $this->Form->control('service_tax',['type'=>'text','label' => false, 'class' => 'form-control', 'placeholder' => 'TAX%','disabled'=>'disabled']); ?>
							...
							<div class="row teachers">
							    <div class="col-xs-6">
							        ...
							        <option value=" <?=$value['id'];?> "><?=$this->Decryption->mc_decrypt($value['firstname'],$value['encryptionkey']).' '.$this->Decryption->mc_decrypt($value['lastname'],$value['encryptionkey']);?></option>
							          <?php }?>  
							        </select>
							    </div>
							    ...
							    <div class="col-xs-6">
									...
									<!-- <p>
									    <kbd>Click</kbd> to select individual name of Teacher drag<br />
									    <kbd>and drop</kbd> in the job assign block
									</p>
									<br />
									<div class="col-sm-6">
									<p>list of  Teacher</p>
									<ul>
									 ...
									 <li><?php //$value['firstname'].' '.$value['lastname'];?></li>
										<?php //}?>
            ...
            $.ajax({
                ...
                success: function(data) {
                   ...
                   // console.log(data);
                    ...
                    //     data +='<thead><tr><th>Start time</th><th>End time</th></tr></thead>';
                    // $(obj).each(function(key,value){
                        
                    //     data +='<tbody><tr><td>'+value["start_time"]+'</td><td>'+value["end_time"]+'</td></tr></tbody>';
