				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 p-t-30">
						...
						<div class="form-group_">
							...
							<i style="font-size:12px">(Password must contain atleast one capital letter and alphanumeric characters.)</i>
						</div>
						<div class="form-group_">
						...
						<div class="text-right m-b-10 m-t-30">
							<?= $this->Form->button('Reset Password',['class' => 'btn bg-deep-purple']);
								echo $this->Form->end();
							?>
						</div>
					</div>
