				...
				<div class="invoice-info" style="width:800px; float:left; margin-top:30px; font-size:13px">
					<div style="width:47%; padding:0; float:left; margin-right: 3%;">
						...
						<div style="padding:20px; border: 1px solid #4099ff;">
							...
							<p><span style="width:160px; display:inline-block"><b>Previous Invoice : </b></span> &euro; 00,00</p>
							<p><span style="width:160px; display:inline-block"><b>Pay by Date : </b></span><?=$final?></p>
							<p><span style="width:160px; display:inline-block"><b>Payable Amount : </b></span> &euro; 00,00</p>
						</div>
					</div>
	<?php 
		$final_charges = '';
						...
						<div style="width:770px; float:left; background:#fff;">
							...
							<div class="invoice-plane-info" style="margin-top:20px">
								<div class="invoice-info__plan-header" style="background-color:#bdc9d7; color:#fff; padding:10px 15px;">
									<h3 style="margin:0; font-size:15px;">This Month Charges for <b><?= $plan['service_type']?></b> <span style="font-size:13px;"><?='('. $plan['service_day'].')'?></span> Plan</h3>
								</div>
								<div class="table-responsive">
									<table Style="border:1px solid #ccc; width:770px;" cellpadding="0" cellspacing="0">
										<tr>	
								...
								<div style="background-color:#fff">
									...
									<table Style="border:1px solid #ccc; width:370px;" cellpadding="0" cellspacing="0">
										...
										<tr>	
											...
											<td style="font-size:12px; padding:10px; border-bottom:1px solid #ccc;"><b>&euro; 00,00</b></td>
										</tr>
										<tr>	
											<td style="font-size:12px; padding:10px; border-right:1px solid #ccc; border-bottom:1px solid #ccc;">Adjustment</td>
											<td style="font-size:12px; padding:10px; border-bottom:1px solid #ccc;"><b>- &euro; 0,00</b></td>
										</tr>
										<tr>	
											...
											<td style="font-size:12px; padding:10px; border-bottom:1px solid #ccc; color:a94442"><b>&euro; <?= round($test_final) ?></b></td>
										</tr>
										<tr>	
											<td style="font-size:12px; padding:10px; border-right:1px solid #ccc; border-bottom:1px solid #ccc;">Invoice Period</td>
											<td style="font-size:12px; padding:10px; border-bottom:1px solid #ccc;"><b><!---12 Aug 2018 - 12 Sept 2018---> 000-00 - 000-00</b></td>
										</tr>
										<tr>	
