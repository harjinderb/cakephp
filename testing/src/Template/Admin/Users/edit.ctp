								...
								<div class="row">
									...
									<div class="col-sm-8 col-md-8">
										...
										<div class="form-group">
											<label>BSO Name  *</label>
											<?= $this->Form->control('firstname',   ['label' => false, 'class' => 'form-control', 'placeholder' => 'BSO Name','value'=> $this->Decryption->mc_decrypt($user['firstname'],$user['encryptionkey'])]); ?>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											-->				<?= $this->Form->control('dob',     ['label' => false, 'class' => 'datepicker form-control', 'placeholder' => 'DOB','type'=>'hidden']);?>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<?= $this->Form->control('confirm_password', ['type'=>'hidden','label' => false, 'class' => 'form-control', 'placeholder' => 'Confirm password','value'=>'']);?>
										</div>
										<div class="form-group">
											<!--  -->
										...
										<div class="text-right m-b-10 m-t-30">
											<?= $this->Form->button('Save',['class' => 'btn btn-lg bg-teal']);
											echo $this->Form->end();
											?>
										</div>
									</div>
