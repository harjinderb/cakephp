					...
					<div class="header">
						<div class="row">
							...
							<div class="col-sm-6 text-right">
								<?php echo $this->Html->link('<span>Go Back</span>',['controller' => 'users', 'action' => 'index'],['escape' => false,'class'=>'btn bg-blue-grey']);
								?>
							</div>
						</div>
					</div>
								...
								<div class="row">
									...
									<div class="col-sm-8 col-md-8">
										<div class="form-group">
											...
											<?= $this->Form->control('firstname',   ['label' => false, 'class' => 'form-control', 'placeholder' => 'Name']); ?>
										</div>
										<div class="form-group">
