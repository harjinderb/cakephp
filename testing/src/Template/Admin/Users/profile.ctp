				...
				<div class="card data-table-outer">
					...
					<div class="body">
						...
						<div class="back-btn text-right cs-btn-group">
							<?php
								echo $this->Html->link('<span>Go Back</span>',['controller' => 'users', 'action' => 'index'],['escape' => false,'class'=>'btn bg-deep-purple waves-effect']);
								if($profile['id']== $this->request->getSession()->read('Auth.User.id')){
									...
									echo $this->Html->link('<span>Edit</span>',['controller' => 'users', 'action' => 'edit',$profile['uuid']],['escape' => false,'class'=>'btn bg-deep-orange waves-effect']);
								}
