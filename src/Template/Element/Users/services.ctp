									...
									<tr>
										...
										<!-- <td><?php// $value['service_type']?> </td> -->
										<td><?php echo date("H:i a", strtotime($value['start_time']));?></td>
										<td><?php echo date("H:i a", strtotime($value['end_time']));?></td>
										<td>
											<?php if (!empty($value['add_teacher_no'])) {?>
									            <span class="label bg-green">Assigned</span>
									        <?php } else {?>
									            <span class="label bg-red">Not Assigned</span>
									        <?php }?>
									     </td>
										<td>
											<div class="cs-btn-group">
									            ...
									            ?>
												<?php 
													echo $this->Form->postLink(__('Assign'), ['controller' => 'users','action' => 'servicesAssign', $value->uuid], ['class' => 'btn btn-warning','escape' => false]);
