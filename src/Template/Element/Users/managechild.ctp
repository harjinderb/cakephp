									...
									<td colspan="9">
											<div class="btm-action pull-right">
												<?php $ServiceDays = array(''=>'Action','3'=>'Delete'); ?>									
												<?= $this->Form->input('service_day', array('type'=>'select','label'=>false, 'class'=>'form-control usersetup', 'options'=>$ServiceDays)); ?>
