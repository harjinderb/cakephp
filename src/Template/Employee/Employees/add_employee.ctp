					...
					<div class="row">
						...
						<div class="col-md-10 col-sm-9">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<label><?=__('Joining Date')?></label>
									  <?= $this->Form->control('joining_date',['type'=>'text','label' => false, 'class' => 'datepicker form-control', 'placeholder' =>  __('Joining Date')]);?>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<?= $this->Form->control('dob',     ['type'=>'text','label' => false, 'class' => 'datepicker form-control', 'placeholder' =>  __('DOB')]);?>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="form-group text-right">
									<?= $this->Form->button(__('Save Employee'),['class' => 'btn btn-theme btn-round-md']);
                        			?>
