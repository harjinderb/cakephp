					...
					<div class="box-body no-padding">
						 <div id="empattendance"  class="attendance-wrap emp-wrap"></div>
							<div class="attendance-info">
								<div class="row">
									<div class="col-md-3">
										<h4> <?=__('Total Present')?>: <span class="present-color">41</span></h4>
									</div>
									<div class="col-md-3">
										<h4><?=__(' Total Leave')?>: <span class="leave-color">04</span></h4>
									</div>
									<div class="col-md-3">
										<h4><?=__(' Total Absent')?>: <span class="absent-color">05</span></h4>
									</div>
									<div class="col-md-3">
										<h4> <?=__('Total Holiday')?>: <span class="holoday-color">57</span></h4>
									</div>
								</div>
							</div>
					</div>
