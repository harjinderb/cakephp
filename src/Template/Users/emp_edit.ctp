							...
							<div class="row">
								...
								<div class="col-sm-8 col-md-8">
										...
										<div class="form-group">
											...
											<?= $this->Form->control('email',     ['label' => false, 'class' => 'form-control','readonly'=> true, 'placeholder' => 'Email Address','value'=> $this->Decryption->emailDecode($user['email'])]);?>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<?= $this->Form->control('dob',     ['type'=>'text','label' => false, 'class' => 'datepicker form-control', 'placeholder' => 'DOB','value'=>date('d-m-Y', strtotime(,'value'=> $this->Decryption->mc_decrypt($user['dob'],$user['encryptionkey'])))]);?>
										</div>
										<div class="form-group">
											<label><?=__('Gender')?></label>
											<?php if($user['gender'] =='1'){?>
											<input name="gender" id="radio_48" class="with-gap radio-col-blue-grey" type="radio" value="1" type="hidden" checked="checked">
											<label for="radio_48"><?=__('Male')?></label>
											<input name="gender" id="radio_49" class="with-gap radio-col-blue-grey" type="radio" value="2" type="hidden">
											<label for="radio_49"><?=__('Female')?></label>
											<?php }else{?>
