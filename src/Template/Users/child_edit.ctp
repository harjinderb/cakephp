                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                             ...
                             <?= $this->Form->control('dob',['type'=>'text','label' => false, 'class' => 'form-control', 'placeholder' => 'DOB','data-dtp'=>'dtp_QF1Am','id'=>'datepicker','type'=>'text','value'=>date('d-m-Y',strtotime($user['dob']))]);?>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                     ...
                     <div class="row">
	                      <div class="col-md-6">
	                           <div class="form-group">
	                              ...
	                              <?= $this->Form->control('school',   ['label' => false, 'class' => 'form-control', 'placeholder' => 'School Name','value' =>$Schools['name'],'type'=>'text']); ?>
	                           </div>
	                    </div>	
	                 </div>
                          <div class="form-group">
