<section class="content">
	<div class="container-fluid">
		<div class="block-header">
			<h2 class="text-uppercase"><i class="fa fa-user"> </i> Add New Student</h2>
			<?= $this->Flash->render() ?>
		</div>
		<div class="m-t-30 back-btn text-right">
			...
			['escape' => false,'class'=>'btn bg-deep-purple waves-effect']);
			?>
		</div>
			...
			<div class="body">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 p-t-30">
						...
						<div class="form-group">
							<label>Parent *</label>
							<?=$this->Form->select('parent_id',$parentlist,['multiple' => false,'value' => [],'label' => false, 'class' => 'form-control']);?>
						</div>
