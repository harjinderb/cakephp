									...
									<div id="example">
											...
											<div class="col-sm-6">
												<div class="form-group service-date">
													...
													<?= $this->Form->control('start_time',['type'=>'text','id'=>'date-start','label' => false, 'class' => 'timepicker form-control', 'placeholder' => 'Start Time','value'=> date("H:i:s", strtotime($service['start_time'])),'id'=>'time']); ?>									
												</div>
											</div>
											<div class="col-sm-6">
												<div class="form-group">
													<label><?=__('End Time')?> *</label>
												<?= $this->Form->control('end_time',['type'=>'text','label' => false, 'id'=> 'date-end','class' => 'timepicker endtime form-control', 'placeholder ' => 'End Time','value'=>date("H:i:s", strtotime($service['end_time'])),'id'=>'timeNew']); ?>
												</div>
											</div>
										</div>
										<div class="row demo-section k-content">
										...
										<div class="box box-default"><div class="box-header"><h3 class="box-title"><?=__('Divide Child And Teachers In Groups')?></h3></div>
										<div class="row demo-section k-content childgroups">
												   <div class="col-sm-12">
											       	<a href="javascript:void(0)" class="btn btn-dark-green btn-round-md" data-attr="" id="check_edit_groups"><?=__('Create group')?></a>
											...
											<div class="col-sm-12 row childs_divide">
												...
												?>
											     <div class="childrows">
											      	...
											      	<div class="col-sm-3">
											      		<div class="removetag">
											      			<a href="javascript:void(0)" class="btn btn-orange btn-round-md" data-attr="" id="child_groups"><?=__('Remove')?></a>
											      		</div>
											      	</div>
											     </div>
											 <?php }
