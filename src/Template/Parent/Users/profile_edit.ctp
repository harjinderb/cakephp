						...
						<div class="nav-tabs-custom cs-tab-round">
								...
								<!-- <form action="" method="" class="form-common profile-form"> -->
									...
									<div class="form-group text-right last-element">
										<div class="row">
											...
											<div class="col-lg-6">
												<?= $this->Form->button(__('Update'),['class' => 'btn btn-theme']);
                        						?>
							...
							<?php echo $this->Form->end(); ?>  
							  ...
							  <div class="tab-pane" id="ChangePassword">
							  	<?php
							  	echo $this->Form->create('',['class'=>'myform profile-form','type'=>'POST','url' => ['controller'=>'Users', 'action' => 'newPassword', 'prefix' => 'parent']]);
							  	?>
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-lg-6">
												  <p id="letter" class="invalid"><?=__('A')?> <b><?=__('lowercase')?></b> letter</p>
												  <p id="capital" class="invalid"><?=__('A')?> <b><?=__('capital (uppercase)')?></b> letter</p>
