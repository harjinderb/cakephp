  <div class="content-wrapper">
    ...
    <section class="content">
		<div class="box box-primary">
				...
				<div class="row">
					...
					<div class="col-xs-5 text-right">
						...
						echo $this->Html->link(
	                     ...
	                     ?>
						<!-- <a href="parent.php" class="btn btn-theme btn-round"> Go to parent list</a> -->
					</div>
				</div>
            ...
            <!-- /.box-header -->
            <div class="box-body">
				<?php echo $this->Form->create($user,['class'=>'form-common myform','type'=>'file']); ?>
					<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										 <label><?=__('Gender')?></label>
			                              <input name="gender" id="radio_48" class="with-gap radio-col-blue-grey" type="radio"> 
			                              <label for="radio_48" class="radio-label"><?=__('Male')?></label>
			                              <input name="gender" id="radio_49" class="with-gap radio-col-blue-grey" type="radio"> 
                        ...
                        <div class="col-md-6">
                           <div class="form-group showrelation"  style="display:none;">
                                ...
                                <?= $this->Form->control('relation',   ['label' => false, 'class' => 'form-control', 'placeholder' => __('Relation with child'),'value' => '','type'=>'text']); ?>
                            </div>
                        </div>
                     </div>
							<div class="form-group">
							...
							<?= $this->Form->button(__('Add Guardian'),['class' => 'btn btn-theme btn-round-md']);?>
