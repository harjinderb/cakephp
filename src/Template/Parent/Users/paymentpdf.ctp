			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<div class="row">
							<div class="col-sm-6">
								<h2 style="border:1px solid; border-color:red">
									INVOICE
								</h2>
							</div>
							<!-- <div class="col-sm-6">
								<?php //echo $this->Html->link('Send Invoice In Mail',['controller' => 'users', 'action' => 'paymentpdf',$childuuid, 'prefix' => 'parent', '?' => ['send_email' => 'true']],['escapeTitle' => false,'class'=>'btn bg-blue-grey','style'=> 'float: right;']);
                            	?>
							</div> -->
						</div>
					</div>
