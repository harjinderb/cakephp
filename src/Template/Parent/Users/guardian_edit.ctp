   ...
   <section class="content">
		<div class="box box-primary">
				...
				<div class="row">
					...
					<div class="col-xs-5 text-right">
						<?php echo $this->Html->link(
	                     'Go to guardian list',
	                     ['controller' => 'users', 'action' => 'employees'],
			...
			<div class="row">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<?= $this->Form->control('dob',     ['type'=>'text','label' => false, 'class' => 'datepicker form-control', 'placeholder' => __('DOB'),'value'=>date('d-m-Y',strtotime($user['dob']))]);?>
									</div>
								</div>
								<div class="col-md-6">
									 <div class="form-group">
                        ...
                        <?php// pr($user['relation']);die;?>
                        <div class="col-md-6">
                           <div class="form-group showrelation <?php if($user['relation'] =='other'){echo 'Show'; }else{ echo 'hide';} ?>">
                                <label><?=('Please specify relation with child *')?></label>
                               <?= $this->Form->control('relation',   ['label' => false, 'class' => 'form-control', 'placeholder' => __('Relation with child'),'value'=> ($getresponse =='other' ? $relationset: '' ),'type'=>'text']); ?>
                            </div>
                        </div>
                     </div>
							<div class="form-group">
