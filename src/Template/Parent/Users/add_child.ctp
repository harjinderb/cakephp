            ...
            <div class="row">
               ...
               <div class="col-xs-5 text-right">
                <?php echo $this->Html->link(
                  ...
                  //$Woonplaats=$parents['encryptionkey'];
                ?>
               </div>
            </div>
         </div>
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              ?>
                             <?= $this->Form->control('dob',['type'=>'text','label' => false, 'class' => 'form-control', 'placeholder' => __('DOB'),'data-dtp'=>'dtp_QF1Am','id'=>'datepicker','value'=> $dob]);?>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                     ...
                     <div class="row">
	                      <div class="col-md-6">
	                           <div class="form-group">
	                              ...
	                              <?= $this->Form->control('school',   ['label' => false, 'class' => 'form-control', 'placeholder' => __('School Name'),'type'=>'text']); ?>
	                           </div>
	                    </div>	
	                     <div class="col-md-6">
		                     <div class="form-group">
                                ...
                                <label for="radio_50" class="radio-label"><?=__('Same as parent')?></label>
                                <input name="group5" id="radio_51" class="with-gap radio-col-blue-grey" type="radio"> 
                                <label for="radio_51" class="radio-label"><?=__('Differnt address')?></label>
