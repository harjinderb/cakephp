    ...
    <div class="container">
        <header class="buy-header">
            <div class="back-to-home">
                ...
                if ($this->request->query('service_id') !== '') {
                    if (strpos($currentURL,'service_id') !== false){
                    echo $this->Html->link(
                        __('Back to Home page'),
                        ['controller' => 'users', 'action' => 'shiftPlan', $userids, 'prefix' => false],['class'=>'btn btn-orange btn-round-lg']
                        ); 
                    ...
                    echo $this->Html->link(
                        __('Back to Home page'),
                        ['controller' => 'users', 'action' => 'buyServices', 'prefix' => 'parent'],['class'=>'btn btn-orange btn-round-lg']
                        ); 
