                        ...
                        <ul class="dropdown-menu">
                           ...
                           <li class="user-header">
                            <?= $this->Html->image(($dataimage!='') ? USER_PICTURE_FOLDER_URL_PATH.$uuid.'/'.$dataimage: '/dist/img/teacher.jpg', ['alt' => $name,'class' => 'img-circle']) ?>
                              <!-- <img src="../dist/img/teacher.jpg" class="img-circle" alt="User Image"> -->
                              <p>
                                 <?= $name ?> - <?=__('Employee')?>
                           ...
                           <li class="user-footer">
                              <div class="pull-left">
                                  <?php echo $this->Html->link(__('Profile'),['controller' => 'Employees', 'action' => 'profileEdit',  'prefix' => 'employee', $uuid],['escapeTitle' => false,'class'=>'btn btn-default btn-flat']);
                                ?>
                              </div>
               ...
               <ul class="sidebar-menu" data-widget="tree">
                  ...
                  <li class="active">
                    <?php 
                        ...
                        ['controller' => 'Employees', 'action' => 'dashboard','prefix'=>'employee'],['escape' => false,'class'=>'pull-right-container'],'<span class="pull-right-container"></span>'); 
                    ?>
                  </li>
                  <li>
                    <?php 
                        echo $this->Html->link('<i class="fa fa-circle-o"></i><span>'.__('Roster').'</span>',
                        ['controller' => 'Employees', 'action' => 'rosterEpanel',$uuid,'prefix'=>'employee'],['escape' => false,'class'=>'pull-right-container'],'<span class="pull-right-container"></span>'); 
                    ?>
                  </li>
                  <li>
                    <?php 
                        echo $this->Html->link('<i class="fa fa-circle-o"></i><span>'.__('Assigned Classes').'</span>',
                        ['controller' => 'Employees', 'action' => 'assignedClasses','prefix'=>'employee'],['escape' => false,'class'=>'pull-right-container'],'<span class="pull-right-container"></span>'); 
                    ?>
                  </li>
                  <li>
                    <?php 
                        echo $this->Html->link('<i class="fa fa-circle-o"></i><span>'.__('Mark Attendance').'</span>',
                        ['controller' => 'Employees', 'action' => 'markAttendance','prefix'=>'employee'],['escape' => false,'class'=>'pull-right-container'],'<span class="pull-right-container"></span>'); 
                    ?>
                  </li>
                  <li>
                    <?php 
                        echo $this->Html->link('<i class="fa fa-circle-o"></i><span>'.__('Attendance').'</span>',
                        ['controller' => 'Employees', 'action' => 'attendance','prefix'=>'employee'],['escape' => false,'class'=>'pull-right-container'],'<span class="pull-right-container"></span>'); 
                    ?>
                  </li>
               </ul>
            </section>
