...
function init_events(ele) {
     ...
     //        var calsettings = $('#calsettings').val();
     //        var get_month = $('#bsoevent').fullCalendar('getDate');
     ...
     //                    });
     //                    });
     //                  $("#bsoevent").fullCalendar('removeEvents'); 
     //                  $("#bsoevent").fullCalendar('addEventSource', event_obj, true);
    ...
    $('#bsoevent').fullCalendar({
      ...
      drop      : function (date, allDay) { // this function is called when something is dropped
        ...
        $('#bsoevent').fullCalendar('renderEvent', copiedEventObject, true)
