					...
					<div class="header">
						<div class="row">
							...
							<div class="col-sm-6 text-right">
								<?= $this->Html->link('<i class="fa fa-pencil"> </i><span>Add new employee</span>', ['controller' => 'Employees','action' => 'addEmployee', 'prefix' => 'employee'], ['class' => 'btn bg-green','escape' => false]);?>
							</div>
						</div>
					</div>
					<div class="body">
